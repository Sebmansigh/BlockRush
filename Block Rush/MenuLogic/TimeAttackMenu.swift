...
class TimeAttackMenu: GameMenu
{
    ...
    override func show(node: SKNode)
    {
        ...
        HSLabel.text = BlockRush.Commafy(value: BlockRush.TimeAttackHighScore);
        ...
        let Lines = [SKLabelNode(text: "Earn the best score"),
                     SKLabelNode(text: "you can in 3 minutes")];
